/* ─────────────────────────────────────────────────────────────
   HotDoc · Mock-Personalliste (Subset)
   In der echten App kommt diese Liste aus syBOS Personal.php API
   (gefiltert auf "Aktiv" + "Veroeffentlicht").
   ───────────────────────────────────────────────────────────── */
...
// kanonische Anzeige
window.PERSONAL.forEach(p => { p.name = `${p.nach} ${p.vor}`; });
